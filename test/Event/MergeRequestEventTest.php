...
class MergeRequestEventTest extends \PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $this->mergeRequestEvent = new \TimoReymann\GitlabWebhookLibrary\Event\MergeRequestEvent(json_decode('
            {
